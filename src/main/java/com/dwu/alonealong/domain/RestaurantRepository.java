...
public interface RestaurantRepository extends CrudRepository<Restaurant, String>{//SQL Mapper와 유사. 엔티티와 꼭 같은 패키지.
	...
	Restaurant findByResId(String resId) throws DataAccessException;
